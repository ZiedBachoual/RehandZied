...
class ChooseGoal2 extends StatefulWidget {
  const ChooseGoal2({super.key});

  @override
  State<ChooseGoal2> createState() => _ChooseGoal2State();
}

class _ChooseGoal2State extends State<ChooseGoal2> {
